...
define("sequencer", default="./sequencer.sh", help="sequence model command", group="model_command")
define("networkplanner", default="./networkplanner.sh", help="networkplanner model command", group="model_command")
define("networker", default="./networker.sh", help="networker model command", group="model_command")
